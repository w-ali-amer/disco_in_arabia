...
Verdict rule stated in advance in the script (committed with the results; no separate prior design doc; project practice adopted the same day requires one before any future 'pre-registered' label), evaluated in
