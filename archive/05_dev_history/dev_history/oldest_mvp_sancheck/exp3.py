...
try:
    ...
    from camel_test2 import analyze_arabic_sentence # Keep if needed separately
...
if __name__ == "__main__":
    ...
    # --- Output Directory ---
    output_dir = "qnlp_experiments_output_revised_v3_per_set" # New output dir name
    os.makedirs(output_dir, exist_ok=True)
        ...
        for i, sentence in enumerate(sentences):
            ...
            try:
                ...
                circuit, diagram, structure, tokens, analyses, roles = \
                    arabic_to_quantum_enhanced(sentence, debug=False, output_dir=set_output_dir) # Save intermediate diagrams/circuits per set
